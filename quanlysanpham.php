...
<body>
                        ...
                        <?php else: ?>
                            <?php foreach ($san_pham_list as $sp): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($sp['HangSX']); ?></td>
                                    <td><?php echo number_format($sp['GiaBan'], 0, ',', '.'); ?> đ</td>
                                    <td><?php echo htmlspecialchars($sp['SoLuongTon']); ?></td>
                                    <td><?php echo htmlspecialchars($sp['MaDM']); ?></td>
                                    <td><img src="uploads/<?php echo htmlspecialchars($sp['HinhAnh']); ?>" style="width:60px;"></td>
                                    <td>
                                        <a href="#" class="btn-edit"
                                            data-masp="<?php echo htmlspecialchars($sp['MaSP']); ?>"
                                            ...
                                            data-hinhanh="<?php echo htmlspecialchars($sp['HinhAnh']); ?>"
                                        >Sửa</a>
    ...
    <div id="add-modal" class="modal-overlay">
        <div class="modal-content" style="max-height:90vh; overflow-y:auto;">
            ...
            <form id="add-product-form" action="xulythemsanpham.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Mã sản phẩm (*):</label>
                    <input type="text" name="masp" required maxlength="9" placeholder="Nhập mã sản phẩm vào đây">
                </div>
                <div class="form-group">
                    <label>Tên sản phẩm (*):</label>
                    <input type="text" name="tensp" required maxlength="69" placeholder="Nhập tên sản phẩm vào đây">
                </div>
                <div class="form-group">
                    <label>Hãng sản xuất (*):</label>
                    <input type="text" name="hangsx" required maxlength="29" placeholder="Nhập hãng sản xuất vào đây">
                </div>
                <div class="form-group">
                    <label>Giá bán (*):</label>
                ...
                <div class="form-group">
                    <label>Mô tả:</label>
                    <textarea name="mota" rows="3" required maxlength="254" placeholder="Nhập mô tả vào đây"></textarea>
                </div>
                <div class="form-group">
    ...
    <div id="edit-modal" class="modal-overlay">
        <div class="modal-content" style="max-height:90vh; overflow-y:auto;">
            ...
            <form id="edit-product-form" action="xulysuasanpham.php" method="POST" enctype="multipart/form-data">
