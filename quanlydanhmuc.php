    ...
    <div class="container main-layout">
        ...
        <main class="main-content">
            <div class="admin-content">
                ...
                ?>
                    <p style="color:red;">
                        Danh mục <b><?php echo "$madm"; ?></b> đang có sản phẩm, không thể xoá.
                    </p>
                <?php endif; ?>
                        ...
                        <?php else: ?>
                            <?php foreach ($danh_muc_list as $dm): ?>
                                <tr>
                                    ...
                                    <td><?php echo nl2br(htmlspecialchars($dm['MoTaDM'])); ?></td>
                                    <td>
                                        <a href="#" class="btn-edit" 
                                        data-madm="<?php echo htmlspecialchars($dm['MaDM']); ?>"
                                        data-tendm="<?php echo htmlspecialchars($dm['TenDM']); ?>"
                                        data-motadm="<?php echo htmlspecialchars($dm['MoTaDM']); ?>">
                                        Sửa
                                        </a>
                                        <a href="xulyxoadanhmuc.php?madm=<?php echo $dm['MaDM']; ?>" 
                                           class="btn-delete"
        ...
        <div class="modal-content">
            ...
            <form id="add-category-form" action="xulythemdanhmuc.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="add-category-id" name="category_id" required maxlength="9" placeholder="Nhập mã danh mục vào đây">
                </div>
                <div class="form-group">
                    <label for="add-category-name">Tên danh mục (*):</label>
                    <input type="text" id="add-category-name" name="category_name" required maxlength="29" placeholder="Nhập tên danh mục vào đây">
                </div>
                <div class="form-group">
                    <label for="add-category-desc">Mô tả:</label>
                    <textarea id="add-category-desc" name="category_desc" rows="4" required maxlength="49"placeholder="Nhập mô tả vào đây"></textarea>
                </div>
