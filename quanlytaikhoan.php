            ...
            <div class="admin-content">
                ...
                <table class="order-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <?php echo htmlspecialchars($tk['MaNV']); ?>
                            </td>
                            <td>
                                <?php echo htmlspecialchars($tk['HoTenNV']); ?>
                            </td>
                            <td>
                                <?php echo htmlspecialchars($tk['VaiTro']); ?>
                            </td>
                            <td>
                                <a href="" class="btn-edit" data-manv="<?php echo htmlspecialchars($tk['MaNV']); ?>"
        ...
        <div class="modal-content">
            ...
            <form id="add-category-form" action="xulythemtaikhoan.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="add-account-id" name="account_id" required maxlength="9"
                        placeholder="Nhập mã nhân viên vào đây">
                </div>
                <div class="form-group">
                    <label for="add-account-name">Họ tên nhân viên (*):</label>
                    <input type="text" id="add-account-name" name="account_name" required maxlength="49"
                        placeholder="Nhập họ tên vào đây">
                </div>
                <div class="form-group">
                    <label for="add-account-password">Mật khẩu (*):</label>
                    <input type="password" id="add-account-password" name="account_password" rows="4" required
                        maxlength="62" placeholder="Nhập mật khẩu vào đây"></input>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form id="edit-account-form" action="xulysuataikhoan.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="edit-account-password" name="account_password" rows="4" required
                        maxlength="62" placeholder="Nhập mật khẩu mới vào đây"></input>
                </div>
                <div class="form-group">
